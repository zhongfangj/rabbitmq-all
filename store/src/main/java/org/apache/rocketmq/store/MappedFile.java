...
public class MappedFile extends ReferenceResource {
    public static final int OS_PAGE_SIZE = 1024 * 4;//OSpage大小，4K
    ...
    private long fileFromOffset; /** 代表该文件代表的文件偏移量。*/
    private File file;  /**   文件对象 */

    /**
     * 对应操作系统的 PageCache。
     *
     * 如果未开启了transientStorePoolEnable， 会使用 FileChannel.map进行内存和磁盘的映射  和  writeBuffer功能类似
     *
     */
    ...
    public AppendMessageResult appendMessagesInner(final MessageExt messageExt, final AppendMessageCallback cb,
        ...
        /**
         * 当前可写指针所在的位置 小于文件总大小   说明当前mappedFile没有满可以写入
         */
        if (currentPos < this.fileSize) {
            /**
             * writeBuffer 只有启用TransientStorePool 时才能使用 ，是mq存储的另一种机制
             *
             *
             */
